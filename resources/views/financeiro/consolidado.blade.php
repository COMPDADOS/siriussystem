...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-blue">
            <span class="caption-subject bold uppercase"> Consolidado</span>
...
<script type="text/javascript">
    ...
    function explodirLancamento( id )
    {
    ...
    function getInformações(data, type, full, meta)
    {
        ...
        texto = '<div class="row">'+
        '   <div class="col-md-1"><a href="javascript:explodirCfc(\''+full.FIN_CFC_ID+'\');"><i class="fa fa-eye"></i></a></div>'+
