...
<!--                        </form>-->
                        <div class="form-group div-center">
                            <div class="row">
                                    <div class="col-md-6 text-primary div-center">
                                        <a class="btn btn-green" href="javascript:email()"><b>Para Locatário:</b>
                                        <p>
                                        Sua senha são os seis primeiro <br> algarismos de seu CPF/CNPJ <br> ou click aqui e receba <br> nova senha e passar a utilizá-la</p></a>
                                        <p class="div-center">
                                    
                                    </div>
    
                                    <div class="col-md-6 text-primary">
                                        <a class="btn btn-warning" href="javascript:email()"><b>Locador:</b>
...
<form style="display: none" action="{{route('meuimovel.meusimoveis')}}" method="POST" id="frm-meusimoveis" target="_blank">            
@csrf
        ...
        $.ajax(
            {
                ...
                success:function(data)
                {
                    ...
                    if( data[0].IDPROP != '' && data[0].IMB_CLT_SENHA != '' && data[0].IMB_CLT_SENHA != senha ) 
                    {
                    ...
                    else
                    {
                        ...
                        if( data[0].IMB_CLT_SENHA != '' && data[0].IMB_CLT_SENHA != senha ) 
                        {
                            alert( 'CPF ou Senha Inválidos! Verifique a ultima senha recebida ou click no botão abaixo para receber nova senha');
                            return false;
                        };
