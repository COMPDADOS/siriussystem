...
<head>
    ...
    <title>Relatório de Retorno - Liquidações</title>
    <style>
    body {
...
<page size="A4">
  ...
  @php
    ...
    $request->replace(['somentebaixados' => 'S', 'codigoocorrencia' => '06']);    
  ...
  <p><h4><u> Relatório de Retorno Bancário LIQUIDAÇÕES</u></h4></p>
  </div>
  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th class="div-center" width="250px">Observaçoes Manuais</th>
    ...
    @endforeach
    <tr>
        <td class="div-center"><hr></td>
        <td class="div-center"><hr></td>
        <td class="div-right"><hr></td>
        <td class="div-right"><hr></td>
        <td class="div-center"><hr></td>
        <td class="div-center"><hr></td>
        <td class="div-center"><hr></td>
      ...
      <tr>
        ...
        <td class="div-center"></td>
        <td class="div-right">{{number_format( $totalpago,2,',','.')}}</td>
        <td class="div-right">{{number_format( $totalbanco,2,',','.')}}</td>
        <td class="div-center"></td>
        <td class="div-center"></td>
        <td class="div-center"></td>
        <td class="div-center"></td>
