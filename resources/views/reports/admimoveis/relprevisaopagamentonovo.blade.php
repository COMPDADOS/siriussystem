		...
		<body>
                ...
                <div class="divTableBody">
                    <div class="divTableRow semborba">
                        ...
                        @endphp                            
                            ...
                            <p id="i-titulo" style="margin: -2;" class="titulo-empresa-center " >{{$titulo}}</p>
                        </div>
                    </div>
                </div>                        
            </div>
            ...
            @foreach( $formas as $forma )
                <div class="divTable">
                    <div class="divTableBody">
                        <div class="divTableRow semborba">
                            Forma: <b><u>{{$forma->IMB_FORPAG_NOME}} </u> </b>
                        </div>
                    </div>
                </div>

                @php
                    $clientesgrupo = app('App\Http\Controllers\ctrRepasse')->distinctBaseGeradaFormaCliente( $forma->IMB_FORPAG_ID );
                    $totalforma = 0;
                @endphp
                @foreach( $clientesgrupo as $clientegrupo)
                    ...
                    @php
                        $clientesforma = app('App\Http\Controllers\ctrRepasse')->distinctBaseGeradaRepassesClienteForma( $forma->IMB_FORPAG_ID, $clientegrupo->IMB_CLT_IDLOCADOR);
                        $totalcliente = 0;
                        $entrou='1';
                ...
                <div class="divTable">
                        <div class="divTableBody">
                            <div class="divTableRow div-center">
                                Total da forma de pagamento {{$forma->IMB_FORPAG_NOME}} -> R$ {{number_format($totalforma,2,',','.')}}</td>
                            </div>
                        </div>
                    </div>                                
                    <div class="divTable">
