...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-gift"></i>Relatórios Administração de Imóveis
        </div>
            <div class="col-md-12">
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <a class="btn dark btn-lg" data-toggle="dropdown">
                            <i class="fas fa-donate"></i> Relatórios de Previsão
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{route('relatorioprevisaorepasse')}}">
                                <i class="fas fa-donate"></i> Previsão de Repasse </a>
                            </li>
                        </ul>
                    </div>
                    <div class="btn-group">
                        <a class="btn dark btn-lg" data-toggle="dropdown">
                            <i class="fas fa-donate"></i> Relatórios Realizados
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{route('caixa.index')}}">
                                <i class="fas fa-donate"></i> Consultar/Lançamento </a>
                            </li>
                            <li>
                                <a href="#">
                                <i class="fas fa-donate"></i> Consolidado</a>
                            </li>
                        </ul>
                    </div>                    
                </div>
