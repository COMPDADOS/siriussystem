                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                            <i class="fa fa-gift"></i>Indice reajuste - Exclusão
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <form action="{{url('/indicereajuste/indicereajuste/apagar')}}/{{$tabela->IMB_IRJ_ID}} " name="form_cliente" 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="IMB_IRJ_NOME" class="form-control" id="i-imb-forpag-nome"
