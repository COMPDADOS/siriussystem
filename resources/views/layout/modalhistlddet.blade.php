<div class="modal fade" id="modalhistlddet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Detalhamento do Repasse
                        </div>
                    </div>
...
<script>
    ...
    {
        var url = "{{route('recibolocador.itensrecibo')}}/"+idrecibo;
        ...
        {        
            ...
            for( nI=0;nI < data.length;nI++)
            {
                linha = '<tr>'+
                    ...
                    '<td class="td-center">'+data[nI].IMB_RLD_LOCADORCREDEB+'</td>' +
                    '<td class="td-rigth">R$ '+formatarBRSemSimbolo( parseFloat(data[nI].IMB_RLD_VALOR))+' </td>' +
                    '<td class="td-center">'+data[nI].IMB_RLD_OBSERVACAO+'</td>' +
                  '</tr>';
            $("#tbldetalherecibo").append( linha );
            } 

        });   
        $("#modalhistlddet").modal('show');
    }
