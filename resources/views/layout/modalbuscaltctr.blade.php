<div class="modal fade" id="modalbuscaltctr-mov" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        $.getJSON( url, function( data)
        {
          ...
          for( nI=0;nI < data.length;nI++)
          {
            ...
            linha =
              ...
              '<a  class="btn btn-sm btn-primary" onclick="selecionarContrato-contrato( '+data[nI].IMB_CTR_ID+')">Selecionar</a>'+
            '    </td>'+
        '</tr>';
