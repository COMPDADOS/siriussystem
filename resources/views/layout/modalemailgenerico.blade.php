<div class="modal fade" id="modalemailgenerico" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <input type="text" id="i-email-modal-generico"
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-primary" id="btn-email-generico">Enviar</button>
                        </div>
                        <div class="col-md-3">
