...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta content="Sirius System - ERP/CRM Imobiliário" name="description" />
                            ...
                            <div class="col-md-2">
                                <div class="inbox-sidebar">
                                    ...
                                    <ul class="inbox-contacts">
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <img class="contact-pic" src="{{asset('/pages/media/users/avatar4.jpg')}}">
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <img class="contact-pic" src="{{asset('/pages/media/users/avatar2.jpg')}}">
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <img class="contact-pic" src="{{asset('/pages/media/users/avatar5.jpg')}}">
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <img class="contact-pic" src="{{asset('/pages/media/users/avatar6.jpg')}}">
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <img class="contact-pic" src="{{asset('/pages/media/users/avatar7.jpg')}}">
...
<![endif]-->
        ...
        <script>
            $(document).ready(function()
            {
                ...
                if( $("#I-IMB_ATD_SOMENTECOMERCIAL").val() == 'S')
                {
                    $("#div-comercial").show();
                    $("#div-botoes-cliente").hide();
                    $("#div-botoes").hide();
