...
<html>
  ...
  <div class="row row-bottom-margin">
       ...
       <img src="{{env( 'APP_URL')}}/storage/images/{{$im->IMB_IMB_ID}}/logos/logoboleto.jpg" alt="alt-logo">
       </div>
    ...
    <div class="row-top-margin">
      <div class="col-xs-2 titulo-10-black-left">
        Término Contrato {{date('d/m/Y',strtotime($ctr->IMB_CTR_TERMINO))}} 
      </div> 
      <div class="col-xs-2 titulo-10-black-left">
        Próximo Reajuste {{date('d/m/Y',strtotime($ctr->IMB_CTR_DATAREAJUSTE))}} 
        </div> 
      <div class="col-xs-2 titulo-10-black-left">
      ...
      <div class="col-xs-2 titulo-11-black">
        @php
           $valortotal = $dadosboleto["valor_boleto_impresso"];
        @endphp
        Valor Documento<br>
        R$ {{$valortotal}}
    ...
    <TR>
      ...
      <TR>
        <TD colspan=4 class=BoletoLogo><img src="{{asset('/global/img/logobanco341.png')}}"></TD>
      ...
      <TR>
        <TD colspan=10 class=BoletoValorEsquerdo style='text-align: left; padding-left : 0.1cm'>
            {{$im->IMB_IMB_NOME}}</TD>
        <TD class=BoletoValorDireito>{{$dadosboleto["agencia"]}}/{{$dadosboleto["conta"]}}-{{$dadosboleto["conta_dv"]}}
                                    </TD>
      </TR>   
      <TR>
