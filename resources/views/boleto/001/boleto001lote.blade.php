  ...
  <div class="div-demonstrativo ">
    ...
    <TR>
      ...
      @foreach( $cpi as $item)
        ...
        @endforeach
        <TR>
            <TD colspan=6 class=itens-left><h5>Referente ao vencimento: <b>{{$dadosboleto->IMB_CGR_VENCIMENTOORIGINAL}}</b></h5><br></TD>
        </TR>
    ...
    <TR>
      ...
      <TR>
        <TD colspan=4 class=BoletoLogo><img src="{{asset('/global/img/logobanco001.png')}}"></TD>
        <TD colspan=2 class=BoletoCodigoBanco>001-9</TD>
      ...
      <TR>
        ...
        <TD colspan=8 Class=BoletoDadosSacado> {{$dadosboleto->sacado}};
      </TR>
      <TR>
