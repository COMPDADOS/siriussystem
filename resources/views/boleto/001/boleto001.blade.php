...
<html>
  ...
  <div class="row row-bottom-margin">
       ...
       <div class="col-xs-6 div-center">
           ...
           <p style="margin: -2;" class="titulo-10-black" >CNPJ: {{app('App\Http\Controllers\ctrRotinas')->formatCnpjCpf( $im->IMB_IMB_CGC )}}</p>
           <p style="margin: -2;" class="titulo-10-black" >{{ $im->IMB_IMB_URL}} -Fones:{{$im->IMB_IMB_TELEFONE1 }}- Creci: {{$im->IMB_IMB_CRECI}}</p>
       </div>
    ...
    <div class="row-top-margin">
      ...
      <div class="col-xs-2 titulo-10-black-left">
          Refer. Vencimento {{$dadosboleto["data_vencimentooriginal"] }} 
      </div> 
