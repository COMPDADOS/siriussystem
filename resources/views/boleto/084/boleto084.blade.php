...
<html>
  ...
  <div class="row row-bottom-margin">
       <div class="col-xs-2 div-left">
           <img src="{{asset('/global/img/logoboleto.png')}}" alt="alt-logo">
       </div>
        ...
        <tbody>
            ...
            @foreach( $cpi as $item)
              <tr>
                ...
                <td class="demonstrativo">{{ number_format($item->IMB_LCF_VALOR, 2, ',', '.')}}</td>
    ...
    <TR>
      ...
      <TR>
        <TD colspan=10 class=BoletoValorEsquerdo style='text-align: left; padding-left : 0.1cm'>
            {{$im->IMB_IMB_NOME}}</TD>
        <TD class=BoletoValorDireito>{{$dadosboleto["agencia"]}}-{{$dadosboleto["agencia_dv"]}}/
                                    {{$dadosboleto["conta"]}}-
