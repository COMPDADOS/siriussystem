...
<TABLE class=Boleto>
    ...
    <div class="container">
           ...
           <div class="row row-bottom-margin">
               ...
               <div class="col-xs-3 div-center">
                   ...
                   {{ date("d/m/Y", strtotime($dadosboleto["data_vencimento"])) }}</span></p>
  ...
  <TR>
    <TD colspan=4 class=BoletoLogo><img src="{{asset('boleto/imagens/104.jpg')}}"></TD>
  ...
  <TR>
    <TD colspan=11 height=60 valign=top><img src="{{asset('boleto/imagens/codbar.jpg')}}"></TD>
  </TR>
  <tr><td colspan=11 class=BoletoPontilhado>&nbsp;</td></tr>  
  </TABLE>
