...
/*    window.onbeforeunload = function(){
    ...
    */
    ...
    function upLoadImagem()
    {
            ...
            var fileList = $("#galeria-imagem-upload")[0].files;
            if (fileList.length > 0) 
            {
                for (let i = 0; i < fileList.length; i += 1) 
                {
                    fd.append('arquivo[]', fileList[i]);
...
//                alert('Enviado Imagem: '+(i+1)+'. Pressione aqui para continuar');
  ...
  */          
    ...
    function gerarSugestaoTitulo()
    {
        ...
        var finalidade='';
        if( valorvenda != 0 && valorlocacao != 0 )
           finalidade = 'Vender ou Aluguar';
        ...
        $(".titulo").val( tipo+' para '+finalidade+' em '+cidade+' no bairro '+bairro );
