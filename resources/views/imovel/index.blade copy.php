...
<style>
    ...
    .p-menor { margin-bottom:-15px;margin-top:-10px;background-color:bisque;}
...
<div class="portlet cor-fundo-pesquisa bordered">
    <div class="portlet-title">
        <div class="col-md-6 lbl-medidas-outrositens">
            <input class="form-control" type="text" id="i-pesquisagenerica"
                    ...
                    <span class="span-10">Campo de Busca Genérica por: Referência, Endereço ou Bairro</span>
        </div>
...
<!--                <input type="hidden" id="i-condominio"  name="condominio">               -->
                ...
                <div class="col-md-3 escondido">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="sel-tipo-locacao" class="control-label">Tipo de Locação</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <label class="control-label">Selecione o Tipo<br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label " for="pre-faixainicial">Faixa de </label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" for="pre-faixafinal">Até</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">Condomínio
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="form-actions noborder cor-fundo-pesquisa">
                            <button class="btn blue pull-right glyphicon glyphicon-search" id='search-form'></button>
                        </div>
                    </div>
...
*/
    ...
    function getInformacoes(data, type, full, meta)
    {
        ...
        comodos = comodos + '&nbsp;&nbsp;&nbsp;&nbsp;<i title="Banheiros" class="fas fa-bath"></i><b>  '+full.IMB_IMV_WCQUA+'</b>';
        ...
        var atualizado= atualizado+'<p>Captação de <b>'+captadores+'</b></p>';
...
/*        if( full.IMB_IMV_TITULO != '' )
        {
             texto=  texto + '<div class="row" height="50%">'+
                    ...
                    if( $("#I-IMB_IMB_IDMASTER").val() == full.IMB_IMB_ID )
                    {
                        texto = texto +
                            '<div class="row"> '+
                            '   <div class="col-md-12 cardtitulo row-top-margin">'+
                            '       <div class="col-md-7 cardtitulo">'+
                            '           <div class="form-group">'+
                        ...
                        texto = texto +
                            ...
                            '   <div class="col-md-3  div-center row-top-margin" >'+
                            '       <div class="form-group">'+
                    ...
                    else
                    {
                        texto = texto +
                            '<div class="row"> '+
                            '   <div class="col-md-12 cardtitulo row-top-margin">'+
                            '       <div class="col-md-6 cardtitulo row-top-margin">'+
                            '           <div class="form-group">'+
                    ...
                    texto = texto +
                        ...
                        '<div class="row"> '+
                        '   <div class="col-md-12 row-top-margin">'+
                        '       <div class="col-md-8 row-top-margin">'+
                        '           </label>'+atualizado+'</label>'+
                        '       </div> '+
                        '       <div class="col-md-4 row-top-margin ">'+
                        '              <div class="col-md-6 row-top-margin">'+
                        '                   <button class="form-control btn btn-primary" onClick="alterarImovel('+full.IMB_IMV_ID+')">Alterar</button>'+
                        '               </div>'+
                        '              <div class="col-md-6 row-top-margin">'+
                        '                <button class="form-control btn btn-danger" onClick="novoContrato('+full.IMB_IMV_ID+')">Alugar</button>'+
                        '             </div>'+
                        '       </div> '+
                        '   </div> '+
                        '</div>';
...
//        window.location = url = "{{route('pdfresumoimovel')}}/"+id;
    ...
    function novoContrato( id, situacao )
    {
        ...
        if  ( carregarOpcao( $("#I-IMB_ATD_ID").val(), 8,1, "{{route('direito.checar')}}",false) == false )
        {
    ...
    {
        var nuser="{{Auth::user()->IMB_ATD_ID}}";
        if  ( carregarOpcao( nuser,  17,4, "{{route('direito.checar')}}",true) == false )
        return false;
