                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id=""  class="form-control input-sm" style="font-family: Tahoma; font-size: 16px" placeholder="Rua,Avenida,Praça...">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        if  ( carregarOpcao( $("#I-IMB_ATD_ID").val(), 167,1, "{{route('direito.checar')}}",false) == false )  
            $("#div-proprietario").hide();
    ...
    function CarregarImagens( nId)
    {
        ...
        $.getJSON( "{{ route( 'imagens.imoveis')}}/"+nId, function( data)
        {
            ...
            for( nI=0;nI < data.length;nI++)
            {
                ...
                linha = 
                        '<tr>'+
                        '<td><a href=javascript:carrousel('+data[nI].IMB_IMG_ID+')><img class="card-img-top" src="{{url('')}}/storage/images/'+
...
//        alert( idchave );
        ...
        var imoveis =
        {
            ...
            IMB_IMV_ARECON :  $("#IMB_IMV_AREUTI").val(),
    ...
    function cargaImovel()
    {
        ...
        $.ajax(
        {
            ...
            success:function( data )
            {
                ...
                $("#IMB_IMV_ANOCONSTRUCAO").val(data.IMB_IMV_ANOCONSTRUCAO );
                ...
                $("#IMB_IMV_RADAR").prop( 'checked',(data.IMB_IMV_RADAR == 'S') );
