                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        id="IMB_IMV_VALVEN" class="form-control valores" 
                                        type="text" 
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9]+([.\,][0-9]+)?" 
                                        id="IMB_IMV_VALLOC"  class="form-control valores" 
                                        placeholder="Não informar centavos">
                                    </div>
                                </div>
...
<script>
    ...
    $('#IMB_IMV_VALLOC').on('blur', () => 
    {
        var valor = parseFloat( $('#IMB_IMV_VALLOC').val() );
        var valorFormatado = valor.toLocaleString('pt-BR', { inimumFractionDigits: 2});
        $('#IMB_IMV_VALLOC').val( valorFormatado );
        if( $('#IMB_IMV_VALLOC').val() =='NaN') 
                    {
...
//            setarSelectCorretor(data.IMB_ATD_ID);
    ...
    function onGravar()
    {
        ...
        var res = valorvenda.replace('.','');
        es = res.replace('.','');
        res = res.replace('.','');
        $("#IMB_IMV_VALVEN").val( res );

        var valorlocacao = $("#IMB_IMV_VALLOC").val();
        res = valorlocacao.replace('.','');
        res = res.replace('.','');
        res = res.replace('.','');
        $("#IMB_IMV_VALLOC").val( res );
