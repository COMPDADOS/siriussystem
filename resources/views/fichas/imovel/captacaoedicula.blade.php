    ...
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Capta&ccedil;&atilde;o de Im&oacute;vel (Edícula) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
