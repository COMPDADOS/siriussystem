              ...
              <div class="portlet-body form">
                <div class="form-body">
                  ...
                  <div class="col-md-3">
                        ...
                        <div class="col-md-3 ">
                          <input title="DDI" type="text" class="form-control " id="i-ddi1"  placeholder="DDI" >
                        </div>
                        <div class="col-md-3 ">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3 ">
                          <input title="DDI" type="text" class="form-control " id="i-ddi2"    placeholder="DDI">
                        </div>
                        <div class="col-md-3 ">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3 ">
                          <input title="DDI" type="text" class="form-control " id="i-ddi3"    placeholder="DDI">
                        </div>
                        <div class="col-md-3 ">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3 ">
                          <input title="DDI" type="text" class="form-control " id="i-ddi4" placeholder="DDI">
                        </div>
                        <div class="col-md-3 ">
