                ...
                <div class="form-body">
                  ...
                  <div class="row">
                    ...
                    <div class='col-md-2'>
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='I-IMB_CLT_DATACADASTRO'>
                    ...
                    <div class='col-md-2'>
                      <div class="form-group">
                        ...
                        <div class='input-group date' id='I-IMB_CLT_DTHALTERACAO'>
                  ...
                  <div class="row">
                    <div class='col-md-3'  id="i-div-data-nascimento">
                      <div class="form-group">
                        <label class="control-label" id="I-IMB_CLT_DATANASCIMENTO" >Data Nascimento</label>
  ...
  function carregarAnexos()
  {
    ...
    function onGravar()
    {
      ...
      var cliente = 
      {
        ...
        IMB_CLT_DATNAS      : $("#I-IMB_CLT_DATNAS").val(),
    ...
    function carregarCliente()
    {
      ...
      $.getJSON( url, function( data)
      {
        ...
        $("#I-IMB_CLT_DATNAS").val( data.IMB_CLT_DATNAS );
...
//        $("#I-IMB_CLT_PESSOA").val( data.IMB_CLT_PESSOA);
        ...
        $.getJSON( url, function( data)
        {
          ...
          if( data[0].LOCADOR != null )
          {
            ...
            $("#i-div-locador").css("background","#5C94F6");                
          };

          if( data[0].LOCATARIO != null )
          {
            $("#i-div-locatario").html('É LOCATÁRIO');
            $("#i-div-locatario").css("background","#5CCDF6");                
          };
            
          if( data[0].FIADOR != null )
          {
            $("#i-div-fiador").html('É FIADOR');
            $("#i-div-fiador").css("background","#AEE2F5");                
          };
