...
use DB;
class ctrSiriusPage extends Controller
{
...
//            ->where('IMB_IMAGEM.IMB_IMG_PRINCIPAL','=','S')
        ...
        return view( 'pagesirius.index', compact('tipoimovel','cidades', 'bairros', 'capa','agencias', 'ultimos'));
