...
class ctrBoleto237 extends Controller
{
...
*/
        ...
        if( $cp )
        {
            ...
            $dadosboleto["FIN_CCI_BANCONUMERO"] = "237";
...
//                dd('aqui');
 ...
 //               dd( "cDatBon $cDatBon -  cValBon: $cValBon - cTipoBon: $cTipoBon");
                ...
                $conteudo .=
                '1'.              //001 a 001
                '00000'.//002 a 006	Agência de Débito
                ' './/007 a 007	Dígito da Agência de Débito
                '00000'.   //008 a 012	Razão da Conta Corrente
                '0000000'.   // 013 a 019	Conta Corrente	007
                ...
                '000'.  //063 a 065	Código do Banco a ser debitado na Câmara de Compensação	003
                ...
                $formaenvio.
                'N'.
                str_repeat( ' ', 10 ). //095 a 104	Identificação da Operação do Banco	010
                ' './/105 a 105	Indicador Rateio Crédito	001
                ' './/106 a 106	Endereçamento para Aviso do Débito Automático em Conta Corrente	001
                '  './/107 a 108	Branco	002
                '01'.//109 a 110	Identificação ocorrência	002
                $this->formata_numero( $cp->IMB_CGR_ID,10,0). //111 a 120	Nº do Documento	010
                $dataencargos. //121 a 126	Data do Vencimento do Título	006
                $cValTot. //127 a 139	Valor do Título	013
                str_repeat( '0', 3 ). //140 a 142	Banco Encarregado da Cobrança	003
                str_repeat( '0', 5 ). //143 a 147	Agência Depositária	005
                '01'.//148 a 149	Espécie de Título	002
                ...
                str_repeat( '0', 13 ).//193 a 205	Valor do IOF	013
                str_repeat( '0', 13 ).//206 a 218	Valor do Abatimento a ser concedido ou cancelado	013
                ...
                $this->formata_numero($conta->FIN_CCI_CONCORNUMERO,7,0 ). //009-013
                $this->formata_numero($conta->FIN_CCI_CONCORDIGITO,1,0 ). //009-013
                $nossonumero.$nossonumeroDV.
                $this->formata_numero(  $nSequencia,6,0) //395 a 400	Nº Seqüencial do Registro	006
                .chr(13).chr(10);
